...
const CanadaDigitalMarketingPage = ({ onOpenCallMe, onOpenEnquiry }) => {
  ...
  const { pageData: dynamicPageData } = useInternationalPageData('canada-digital-marketing', defaultPageData);
  ...
  return (
    <div className="wm-intl-canada-page-root">
          ...
          <div className="wm-intl-canada-services-grid">
            {pageData.services.map((svc, i) => (
              <div key={i} className="wm-intl-canada-service-card">
                <div className="wm-intl-canada-svc-card-glow"></div>
                <div className="wm-intl-canada-svc-card-top">
                  ...
                  <span className="wm-intl-canada-svc-num">0{i + 1}</span>
                </div>
                <h3>{svc.title}</h3>
                <p>{svc.desc}</p>
                <div className="wm-intl-canada-svc-card-footer">
                  <button
                    type="button"
                    className="wm-intl-canada-svc-card-btn"
                    onClick={() => onOpenEnquiry && onOpenEnquiry(`${pageData.name} - ${svc.title}`)}
                  >
                    <span>Explore Solution</span>
                    <FaArrowRight className="wm-intl-canada-svc-arrow" />
                  </button>
                </div>
              </div>
            ))}
          ...
          <div className="wm-intl-canada-market-grid">
            {pageData.marketInsights.map((mi, i) => (
              <div key={i} className="wm-intl-canada-market-card">
                <div className="wm-intl-canada-market-card-glow"></div>
                <div className="wm-intl-canada-market-card-hdr">
                  <div className="wm-intl-canada-market-badge-wrap">
                    <span className="wm-intl-canada-market-badge">MARKET DYNAMICS</span>
                    <span className="wm-intl-canada-market-num">0{i + 1}</span>
                  </div>
                  <div className="wm-intl-canada-market-pulse-dot"></div>
                </div>
                <h4>{mi.title}</h4>
                <p>{mi.desc}</p>
              </div>
          ...
          <div className="wm-intl-canada-process-grid">
            {pageData.processSteps.map((ps, i) => (
              <div key={i} className="wm-intl-canada-process-card">
                <div className="wm-intl-canada-proc-card-glow"></div>
                <div className="wm-intl-canada-proc-header-row">
                  <span className="wm-intl-canada-proc-num">0{i + 1}</span>
                  <div className="wm-intl-canada-proc-icon">
                    {i === 0 && <FaRegLightbulb />}
                ...
                <h4>{ps.title}</h4>
                <p>{ps.desc}</p>
                <div className="wm-intl-canada-proc-step-tag">Phase 0{i + 1}</div>
              </div>
            ))}
          </div>
        </div>
          ...
          <div className="wm-intl-canada-industries-grid">
            {pageData.industries.map((ind, i) => (
              <div key={i} className="wm-intl-canada-industry-card">
                <div className="wm-intl-canada-ind-card-top">
                  ...
                  <span className="wm-intl-canada-ind-tag">VERTICAL 0{i + 1}</span>
                </div>
                <h4>{ind.name}</h4>
                <p>{ind.desc}</p>
              </div>
      ...
      <section className="wm-intl-canada-pricing-section" id="pricing-plans">
        <div className="wm-intl-canada-container">
          <div className="wm-intl-canada-sec-heading-center">
            ...
            {/* Currency Switcher */}
            <div className="wm-intl-canada-currency-toggle" style={{ marginTop: '24px' }}>
      ...
      <section className="wm-intl-canada-advantage-section" id="why-us-guarantees">
        <div className="wm-intl-canada-container">
          <div className="wm-intl-canada-sec-heading-center">
          ...
          <div className="wm-intl-canada-advantage-grid">
            <div className="wm-intl-canada-advantage-card">
              <div className="wm-intl-canada-adv-glow"></div>
              <div className="wm-intl-canada-adv-top">
                <div className="wm-intl-canada-aicon"><FaShieldAlt /></div>
                <span className="wm-intl-canada-adv-badge">STANDARDS</span>
              </div>
              ...
              <div className="wm-intl-canada-adv-check-row">
                <FaCheck className="wm-intl-canada-adv-check" /> <span>Google Webmaster Certified</span>
              </div>
            </div>
            ...
            <div className="wm-intl-canada-advantage-card">
              ...
              <div className="wm-intl-canada-adv-top">
                ...
                <span className="wm-intl-canada-adv-badge">TELEMETRY</span>
              </div>
              ...
              <div className="wm-intl-canada-adv-check-row">
                <FaCheck className="wm-intl-canada-adv-check" /> <span>24/7 Live BI Access</span>
              </div>
            </div>
            ...
            <div className="wm-intl-canada-advantage-card">
              ...
              <div className="wm-intl-canada-adv-top">
                ...
                <span className="wm-intl-canada-adv-badge">DEDICATED</span>
              </div>
              <h4>Dedicated Senior Squad</h4>
              <p>Work directly with dedicated senior strategists and technical growth engineers on call.</p>
              <div className="wm-intl-canada-adv-check-row">
                <FaCheck className="wm-intl-canada-adv-check" /> <span>Direct Senior Access</span>
              </div>
            </div>
            ...
            <div className="wm-intl-canada-advantage-card">
              ...
              <div className="wm-intl-canada-adv-top">
                ...
                <span className="wm-intl-canada-adv-badge">FLEXIBILITY</span>
              </div>
              <h4>Zero Mandatory Lock-In</h4>
              <p>Flexible month-to-month contracts. You continue because you see compounding results and profitable pipeline.</p>
              <div className="wm-intl-canada-adv-check-row">
                <FaCheck className="wm-intl-canada-adv-check" /> <span>Month-to-Month Freedom</span>
              </div>
            </div>
          </div>
        </div>
