...
const WordPressServicesPage = ({ onOpenCallMe, onOpenEnquiry, onOpenServiceInquiry }) => {
                ...
                <div className="wm-seopk__grid">
                  ...
                  <div className="wm-seopk__c  ">
                    ...
                    <button
                      ...
                      onClick={() => (onOpenServiceInquiry || onOpenEnquiry)('WordPress Development', 'Starter Website')}
                    >
                      Choose Starter &rarr;
                    </button>
                  </div>
                  <div className="wm-seopk__c wm-seopk__c--hi ">
                    ...
                    <button
                      ...
                      onClick={() => (onOpenServiceInquiry || onOpenEnquiry)('WordPress Development', 'Growth Custom Portal')}
                    >
                      Choose Growth &rarr;
                    </button>
                  </div>
                  <div className="wm-seopk__c  ">
                    ...
                    <button
                      className="wm-seopk__cta wm-seopk__cta--o"
                      onClick={() => (onOpenServiceInquiry || onOpenEnquiry)('WordPress Development', 'Enterprise Scale')}
                    >
                  ...
                  <div className="wm-seopk__c  wm-seopk__c--dark">
                    ...
                    <button
                      className="wm-seopk__cta wm-seopk__cta--y"
                      onClick={() => (onOpenServiceInquiry || onOpenEnquiry)('WordPress Development', 'Dedicated Retainer')}
                    >
            ...
            <div className="wm-rsau">
              <div className="wm-rsau__grid">
                <div>
                  ...
                  <DiagnosticLeadForm serviceName="WordPress Development" />
