          ...
          <div className="wm-sp-main-col">
            ...
            <section className="wm-dsm-stack">
              ...
              <div className="wm-dsm-stack__foot">
                ...
                <button type="button" onClick={() => onOpenEnquiry && onOpenEnquiry('Social Media Graphic Design Services Company - Scope Consultation')}>
                  ...
                  {pricing.map((plan, i) => (
                    ...
                    >
                      ...
                      <button
                        ...
                        onClick={() => onOpenEnquiry && onOpenEnquiry(`Social Media Graphic Design Services Company - ${plan.name} Plan`)}
                      >
            ...
            <div className="wm-sp-card wm-sp-bottom-cta">
              ...
              <div className="wm-sp-bottom-btns">
                <button
                  ...
                  onClick={() => onOpenEnquiry && onOpenEnquiry('Social Media Graphic Design Services Company - Proposal Request')}
                >
