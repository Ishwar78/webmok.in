...
const EnterpriseWebServicesPage = ({ onOpenCallMe, onOpenEnquiry, onOpenServiceInquiry }) => {
                ...
                <div className="wm-seopk__grid">
                  ...
                  <div className="wm-seopk__c  ">
                    ...
                    <button
                      ...
                      onClick={() => (onOpenServiceInquiry || onOpenEnquiry)('Enterprise Web Development', 'Core Enterprise Portal')}
                    >
                      Choose Core &rarr;
                    </button>
                  </div>
                  <div className="wm-seopk__c wm-seopk__c--hi ">
                    ...
                    <button
                      ...
                      onClick={() => (onOpenServiceInquiry || onOpenEnquiry)('Enterprise Web Development', 'Advanced Scalable Portal')}
                    >
                  ...
                  <div className="wm-seopk__c  ">
                    ...
                    <button
                      className="wm-seopk__cta wm-seopk__cta--o"
                      onClick={() => (onOpenServiceInquiry || onOpenEnquiry)('Enterprise Web Development', 'Full-Scale Enterprise Platform')}
                    >
                  ...
                  <div className="wm-seopk__c  wm-seopk__c--dark">
                    ...
                    <button
                      className="wm-seopk__cta wm-seopk__cta--y"
                      onClick={() => (onOpenServiceInquiry || onOpenEnquiry)('Enterprise Web Development', 'Enterprise Retainer & SLA')}
                    >
            ...
            <div className="wm-rsau">
              <div className="wm-rsau__grid">
                <div>
                  ...
                  <DiagnosticLeadForm serviceName="Enterprise Web Portals" />
