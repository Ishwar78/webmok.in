...
const MarketplaceServicesPage = ({ onOpenCallMe, onOpenEnquiry, onOpenServiceInquiry }) => {
                ...
                <div className="wm-seopk__grid">
                  ...
                  <div className="wm-seopk__c  ">
                    ...
                    <button
                      ...
                      onClick={() => (onOpenServiceInquiry || onOpenEnquiry)('Marketplace Development', 'Core Marketplace MVP')}
                    >
                      Choose Core &rarr;
                    </button>
                  </div>
                  <div className="wm-seopk__c wm-seopk__c--hi ">
                    ...
                    <button
                      ...
                      onClick={() => (onOpenServiceInquiry || onOpenEnquiry)('Marketplace Development', 'Commercial Scale Platform')}
                    >
                  ...
                  <div className="wm-seopk__c  ">
                    ...
                    <button
                      className="wm-seopk__cta wm-seopk__cta--o"
                      onClick={() => (onOpenServiceInquiry || onOpenEnquiry)('Marketplace Development', 'Enterprise Multi-Sided Network')}
                    >
                  ...
                  <div className="wm-seopk__c  wm-seopk__c--dark">
                    ...
                    <button
                      className="wm-seopk__cta wm-seopk__cta--y"
                      onClick={() => (onOpenServiceInquiry || onOpenEnquiry)('Marketplace Development', 'Marketplace DevOps Retainer')}
                    >
            ...
            <div className="wm-rsau">
              <div className="wm-rsau__grid">
                <div>
                  ...
                  <DiagnosticLeadForm serviceName="Custom Marketplace" />
