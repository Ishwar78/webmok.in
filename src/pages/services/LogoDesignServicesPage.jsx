...
const LogoDesignServicesPage = ({ onOpenCallMe, onOpenEnquiry }) => {
  ...
  return (
    <div className="logodesignservicespage-root wm-sp-root">
      ...
      <HeroLeadForm
        badge="Bespoke Brand Identity"
        title="Custom Logo Design & Brand Identity Studio in India"
        subtitle="Create an unforgettable visual trademark for your business. We engineer distinctive, timeless, and trademark-ready logos built on deep brand strategy, vector craftsmanship, and golden-ratio precision."
        stats={stats}
      />
          ...
          <div className="wm-sp-main-col">
            ...
            <section className="wm-dsm-stack">
              ...
              <div className="wm-dsm-stack__foot">
                ...
                <button type="button" onClick={() => onOpenEnquiry && onOpenEnquiry('Logo Design Services Company - Scope Consultation')}>
                  ...
                  {pricing.map((plan, i) => (
                    ...
                    >
                      ...
                      <button
                        ...
                        onClick={() => onOpenEnquiry && onOpenEnquiry(`Logo Design Services Company - ${plan.name} Plan`)}
                      >
            ...
            <div className="wm-sp-card wm-sp-bottom-cta">
              ...
              <div className="wm-sp-bottom-btns">
                <button
                  ...
                  onClick={() => onOpenEnquiry && onOpenEnquiry('Logo Design Services Company - Proposal Request')}
                >
